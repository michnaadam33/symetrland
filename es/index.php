...
<head>
    ...
    <link rel="alternate" hreflang="pl" href="http://symetrland.com/pl/" />
            ...
            <div class="h_menu4"><!-- start h_menu4 -->
                <div class="header-left">
                    ...
                    <div class="header-left-text">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="#skills" class="scroll">CAPACIDADES</a></li>
                ...
                <div class="header-right">
                    <ul class="nav">
                        ...
                        <li><a href="/pl" class="language">PL</a></li>
                    </ul>
                </div>
                <div class="clearfix"></div>
            </div>
        ...
        <div class="what-main">
            ...
            <div class="what-top">
                <div class="col-md-6 what-top-left">
                    <h4><span>Soy</span> Web developer</h4>

                    <p>Adam. Él es el más creativa persona en su campo. Le gustaría investigar todos los secretos qué no han sido descubiertos. No solo no ve ninguna frontera en tecnología sino también en nuestro mundo. Le encantan viajes, montañas, aventuras y desafíos. En su tiempo libre explore el mundo viajando a dedo. Para Él - imposible no existe.</p>
                </div>
            ...
            <div class="touch-top">
                ...
                <div class="col-md-6 touch-left">
                    ...
                    <form action="index.php#contact" method="POST">
                        <input type="text" name="name" class="active" placeholder="Nombre" required="">
                ...
                <div class="col-md-6 touch-right">
                    <div class="touch-right-bottom">
                        <div class="touch-right-top">
                            ...
                            <h4><label>CRACOVIA, POLONIA</label></h4>
                        </div>
                        <div class="touch-right-top">
