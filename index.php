        ...
        <div class="what-main">
            ...
            <div class="what-top">
                <div class="col-md-6 what-top-left">
                    <h4><span>I am a</span> Web developer</h4>

                    <p>Adam. He is considered to be the most creative person in his field. He wants to find out all the secrets which have not been discovered by the world. He doesn't see any borders in technology as well as in the world. He loves travelling, mountains, adventures and challenges. In his free time, he explores the world. He is a perfect hitchhiker. For him, impossible is nothing. </p>
                </div>
            ...
            <div class="touch-top">
                ...
                <div class="col-md-6 touch-left">
                    ...
                    <form action="index.php#contact" method="POST">
                        <input type="text" name="name" class="active" placeholder="Name" required="">
                ...
                <div class="col-md-6 touch-right">
                    <div class="touch-right-bottom">
                        <div class="touch-right-top">
                            ...
                            <h4><label>CRACOW, POLAND</label></h4>
                        </div>
                        <div class="touch-right-top">
